...
<section class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-black focus:ring-4">
                Ayo Pesan Sekarang
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 max-w-7xl mx-auto mb-12">
          ...
          <div class="bg-white  rounded-2xl shadow-xs transition-transform hover:shadow-sm hover:-translate-y-1 duration-300">
              ...
              <div class="p-4">
                  ...
                  <p class="text-blue-600 font-bold text-lg mb-2">Rp 1.000.000</p>
